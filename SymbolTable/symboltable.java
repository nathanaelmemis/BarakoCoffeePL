    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            while((currentLine=bf.readLine())!=null){
                    ...
                    else if(currentLine.contains("boolean")&& !currentLine.contains("(") && !currentLine.contains(")") && !currentLine.contains("'")){
                        ReadVariables();
                    }//add
                    else if(currentLine.contains("String")&& !currentLine.contains("(") && !currentLine.contains(")") && !currentLine.contains("'")){
                        ReadVariables();
                    }
